...
8. **Stop at the current approved phase.** T1 (verification foundations) is in progress. Do not start D1, media processing, real backends, agents, model integration, or a public demo until T1 is reviewed.
